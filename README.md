...
```
It should bring up a `nwjs` window with the image, and save that image as a PNG file too.
...
This quick test is analogous to [Étienne Tétreault-Pinard](https://github.com/etpinard)'s [mapbox-gl-in-nwjs](https://gist.github.com/etpinard/5d58ef47d65d65cd1e93d825659936af) test.